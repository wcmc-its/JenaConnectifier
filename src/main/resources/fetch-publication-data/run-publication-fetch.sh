...
export HARVEST_NAME=import-publication
export DATE=`date +%Y-%m-%d'T'%T`
export JENACONNECTIFIER_DIR=$JENACONNECTIFIER_INSTALL_DIR/src/main/resources/fetch-publication-data
...
EXCEPTION=$(grep Exception $JENACONNECTIFIER_DIR/logs/import-publication.latest.log)
