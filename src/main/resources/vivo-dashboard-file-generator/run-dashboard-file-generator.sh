...
export JENACONNECTIFIER_INSTALL_DIR=/opt/JenaConnectifier/
export HARVEST_NAME=import-appointments
export DATE=`date +%Y-%m-%d'T'%T`
export JENACONNECTIFIER_DIR=$JENACONNECTIFIER_INSTALL_DIR/src/main/resources/fetch-appointments-to-dashboard
...
EXCEPTION=$(grep Exception $JENACONNECTIFIER_DIR/logs/import-appointments.latest.log)
