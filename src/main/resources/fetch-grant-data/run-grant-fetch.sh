...
export HARVEST_NAME=import-grants
export DATE=`date +%Y-%m-%d'T'%T`
export JENACONNECTIFIER_DIR=$JENACONNECTIFIER_INSTALL_DIR/src/main/resources/fetch-grant-data
...
EXCEPTION=$(grep Exception $JENACONNECTIFIER_DIR/logs/import-grants.latest.log)
