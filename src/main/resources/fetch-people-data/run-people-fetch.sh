...
export HARVEST_NAME=import-people
export DATE=`date +%Y-%m-%d'T'%T`
export JENACONNECTIFIER_DIR=$JENACONNECTIFIER_INSTALL_DIR/src/main/resources/fetch-people-data
...
EXCEPTION=$(grep Exception $JENACONNECTIFIER_DIR/logs/import-people.latest.log)
