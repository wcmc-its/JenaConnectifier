...
export HARVEST_NAME=delete-profile
export DATE=`date +%Y-%m-%d'T'%T`
export JENACONNECTIFIER_DIR=$JENACONNECTIFIER_INSTALL_DIR/src/main/resources/delete-profile
...
EXCEPTION=$(grep Exception $JENACONNECTIFIER_DIR/logs/delete-profile.latest.log)
